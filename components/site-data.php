<?php
  ...
  $menu_main = array("Avaleht" => "index.php", "Uudised" => "news.php", "Meeskond" => "team.php", "Harjutused" => "exercises.php","Lisaülesanne" => "extra_exercises.php");
  ...
  $extra_exercises = "Lisan siia lambi teksti";
